/**
 * Bar View JavaScript
 * Handles the bar view functionality for drink orders
 */
...
class BarView {
   ...
   */
  init() {
    console.log('Initializing Bar View...');
  ...
  async loadOrders() {
    try {
      ...
      queryParams.append('type', 'drink'); // Only drink orders for bar view
      if (statusFilter !== 'all') {
...
// Initialize the bar view when the DOM is loaded
