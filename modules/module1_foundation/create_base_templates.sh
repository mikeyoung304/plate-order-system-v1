...
# Task: Create Base Templates
# This script creates reusable base templates and components for the application

echo "Starting task: Create Base Templates"
echo "=================================="
...
# Card component
cat > "$COMPONENTS_DIR/card.html" << 'EOF'
<div class="card p-4">
...
# Button component
cat > "$COMPONENTS_DIR/button.html" << 'EOF'
<button 
...
cat > "$COMPONENTS_DIR/form_input.html" << 'EOF'
<div class="mb-4">
...
# Alert component
cat > "$COMPONENTS_DIR/alert.html" << 'EOF'
...
# Update index.html to use the base template
echo "Updating index.html to use the base template..."
...
if [ -f "$TEMPLATES_DIR/base.html" ] && [ -d "$COMPONENTS_DIR" ] && [ -f "$TEMPLATES_DIR/index.html" ]; then
...
echo "Task completed: Create Base Templates"
exit 0
