...
from app.api import orders, residents, tables, floor_plan, websocket, speech, listen, settings as settings_router
from app.core.dependencies import get_monitoring, get_speech
