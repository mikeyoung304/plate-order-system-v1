    ...
    def get_system_metrics(self) -> Dict[str, Any]:
        ...
        return {
            "audio_recording_duration": {
                ...
                "avg": (
                    self.audio_recording_duration._sum.get()
                    / self.audio_recording_duration._count.get()
                    if self.audio_recording_duration._count.get() > 0
                    else 0
                ),
            },
            "transcription_duration": {
                ...
                "avg": (
                    self.transcription_duration._sum.get()
                    / self.transcription_duration._count.get()
                    if self.transcription_duration._count.get() > 0
                    else 0
                ),
            },
